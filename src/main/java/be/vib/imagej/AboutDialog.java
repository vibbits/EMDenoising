	...
	private class AboutPanel extends JPanel
	{
		public AboutPanel()
		{
			...
			JLabel title = new JLabel("<html><div align='center'>" + 
			                          "<font size=+1>DenoisEM v1.1.0</font><br>" +   // TODO: centralize the version number, or extract it from the jar filename or so
			                          "</html>", JLabel.CENTER);
			...
			JLabel copyright = new JLabel("<html><div align='center'>" + 
                                          "&copy; VIB 2017-2019. All rights reserved." + 
                                          "</html>", JLabel.CENTER);
